    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* KDS - Destacado */}
                <Link href="/production/kds?from=admin" className="bg-primary/5 border-2 border-primary/20 rounded-[40px] p-8 shadow-sm hover:border-primary transition-all group flex flex-col justify-between">
                    <div>
